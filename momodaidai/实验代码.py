...
if __name__ == '__main__':
    ...
    url_detail = 'http://10.0.5.159:8881/complaints/CaseDataReception/selectByAll.do?'
    header_detail = {'Content-Type': 'application/json;charset=UTF-8',
                      'Cookie':'JSESSIONID=902FCC14DC134B6BC958F841FEC7D8FC'}
    data_detail = {"caseDateStart": "", "caseDateEnd": "", "caseSource1": "0010001", "intPageSize": 10,
                   "intPageIndex": 1}

    send = SendRequests()

    res_cms_login = send.execute_api_request(api_name=None, url=url_detail, method='post', headers=header_detail,
                                         case_name=None,
                                         data=data_detail)
    print(res_cms_login.text)
